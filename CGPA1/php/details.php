...
<body onload="uname('student')">
<div id="top">
<nav class="top1">
<div id="topcon">
<li><a href="/CGPA1/html/index.html"><i class="fa fa-home icon2"><spacer style="margin-left:5px;">Home</spacer></i></a></li>
<li><a href="Post.php"><i class="	fas fa-save icon2"><spacer style="margin-left:5px;">Saved Data</spacer></i></a></li>
 </div>
...
<form  method="post" action="/CGPA1/php/cgpa.php">
<div id="back">
...
<option value="Summa" disabled selected>Select Regulation</option>
<option value="16">2016</option>
<option value="19">2019</option>
</select>
<br>
<select id="sem" name="sem">
<option value="Summa" selected disabled>Select Your Semester</option>
